...
<div class="container">
        ...
        <form action="" method="POST" class="m-5 text-light">
            @csrf
            @method('PUT')
            <h1 class="py-3">Modifier article</h1>
            @if ($errors->any())
            ...
            <div class="row mb-3 mt-2">
                ...
                <label for="titre_fr" class="col-sm-1 col-form-label">Titre</label>
                <div class="col-sm-10">
            ...
            <div class="row mb-3 mt-2">
                ...
                <label for="contenu" class="col-sm-1 col-form-label">Contenu</label>
                <div class="col-sm-10">
            ...
            <div class="d-flex justify-content-around">
                ...
                <a href="{{ route('liste.article') }}" class="btn btn-outline-danger">Retur</a> 
            </div>
